...
class PermissionSeeder extends Seeder
{
	...
	public function run()
	{
		...
		if (app()->environment() != 'testing') {
			$user = User::firstOrCreate(['id' => 1], ['email' => 'info@info.com', 'name' => 'Super Admin', 'username' => 'admin', 'mobile' => '+970567940999', 'image' => "https://api.dicebear.com/9.x/pixel-art/svg", 'password' => bcrypt("TESTtest1!")]);
